function [Ax_large, Az_large, bx_large, bz_large, size_out] = getmat_pg_vSimp_nophi0(u, w_kernel, dinf, og_size, stride)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%    
    ...
    for jj = 1:st:og_size(2)
        ...
        for ii = 1:st:og_size(1) %% for faster computing pararell toolbox
            ...
            resx_small = Az_small\bz_small; % 2 channels [kx phi0]
